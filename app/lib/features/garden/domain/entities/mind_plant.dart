...
part 'mind_plant.freezed.dart';
part 'mind_plant.g.dart';

@freezed
class MindPlant with _$MindPlant {
  const factory MindPlant({
    required String id,
  ...
  const MindPlant._(); // Required for custom methods/getters in Freezed

  factory MindPlant.fromJson(Map<String, dynamic> json) =>
      _$MindPlantFromJson(json);
